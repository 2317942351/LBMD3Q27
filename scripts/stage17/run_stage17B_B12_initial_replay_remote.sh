...
ROOT="${ROOT:-/mnt/usb1t/RUNS/runs/stage17B_B12_initial_replay_20260625}"
CASE_SRC="${CASE_SRC:-/home/yuan/stage17B_B12_initial_replay_cases}"
CASE_NAME="${CASE_NAME:-cylinder_init090_b12_initial_replay_s0001}"
BIN="${BIN:-/home/yuan/src/TCLB_lbm2026_compile_lane/CLB/d3q27_pf_velocity_q27_geometric/main}"
GPU="${GPU:-1}"
TIMEOUT="${TIMEOUT:-600}"
PURPOSE="${PURPOSE:-stage17B_B12_initial_replay_pre_collision_probe}"
...

{
  ...
  echo "claim_limit=B12 initial replay diagnostic only; not contact-angle validation"

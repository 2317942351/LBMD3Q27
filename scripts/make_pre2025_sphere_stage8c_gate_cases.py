#!/usr/bin/env python3
"""Generate Stage8c z48 sphere local-transfer/shadow diagnostic cases.

These cases are runtime_sanity / exploratory_not_validation diagnostics. They
do not claim PRE reproduction or validation.
"""
...
CASE_DIR = Path("cases") / "diagnostics" / "pre2025_sphere_stage8c_local_transfer_shadow_20260612"
REMOTE_ROOT = (
    "/mnt/8A0E24070E23EAC1/runs/"
    "tclb_pre2025_sphere_stage8c_local_transfer_shadow_20260612"
)
BINARY = (
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--failcheck-interval", type=int, default=10)
...
<!--
  Stage8c z48 sphere local wall-angle transfer and shadow candidate gate.
  Status: {STATUS} / exploratory_not_validation.
  Geometry: 80x80x180, R_drop=24, R_solid=24, solid_center_z=48.
  OuterDomain radAngle={args.outer_rad_angle_deg:g}d; SolidSphere radAngle={args.sphere_rad_angle_deg:g}d.
...
def main() -> None:
    ...
    manifest = {
        ...
        "purpose": "Stage8c z48 sphere local-transfer step0/short shadow gate",
        "binary": args.binary,

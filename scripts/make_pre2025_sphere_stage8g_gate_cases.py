#!/usr/bin/env python3
"""Generate Stage8g z48 sphere shadow diagnostic cases."""
...
from make_flat_wall_cap_stage8g_cases import STAGE8G_VTK


STATUS = "runtime_sanity"
CASE_DIR = Path("cases") / "diagnostics" / "pre2025_sphere_stage8g_shadow_20260613"
REMOTE_ROOT = "/media/yuan/新加卷1/RUNS/runs/stage8/stage8g_cap_contract_revision_diag_20260613/sphere"
BINARY = (
...
<!--
  Stage8g z48 sphere shadow diagnostic.
...
{init.sphere_cap_xml}
    ...
    <Param name="Stage8gMode" value="{mode}"/>
...
def main() -> None:
    ...
    for mode in [0, 1, 2, 3]:
        for init in init_cases():
            case_id = f"theta030_{init.suffix}_stage8g_mode{mode}"
    ...
    manifest = {
        ...
        "purpose": "Stage8g z48 sphere shadow diagnostic gate",
        "binary": args.binary,

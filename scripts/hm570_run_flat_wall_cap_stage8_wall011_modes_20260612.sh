...
# Run Stage8 fluid-boundary-gradient wetting diagnostic wall011 mode cases.
# Status: runtime_sanity / exploratory_not_validation.
# Raw VTI/PVTI/PRI stay on HM570; no tar/archive is produced here.

RUN_ROOT="${1:-/mnt/8A0E24070E23EAC1/runs/tclb_flat_wall_cap_stage8_wall011_modes_20260612}"
LOCAL_CASE_STAGING="${LOCAL_CASE_STAGING:-/tmp/flat_wall_cap_stage8_wall011_modes_cases}"
BINARY="${BINARY:-/home/yuan/src/TCLB_stage8_boundary_fluid_gradient_wetting_diag_20260612/CLB/d3q27_pf_velocity_q27_geometric/main}"
...
FINITE_ARRAYS="${FINITE_ARRAYS:-PhaseField,U,P,Rho,WallStage8GradMode,WallStage8ActiveWeight,WallStage8NormalGradRaw,WallStage8NormalGradTarget,WallStage8ContactResidual,WallStage8TangentGradMag,WallStage8TargetCos,WallStage8GradWriteDeltaMag,WallStage8LimiterReason}"
...
mkdir -p "$RUN_ROOT"
batch_log="$RUN_ROOT/batch_flat_wall_cap_stage8_wall011_modes.log"
current_case_dir=""
...

{
  ...
  echo "status=runtime_sanity"
  echo "purpose=flat_wall_spherical_cap_gate_stage8_wall011_modes"

...
# Run Stage7b wall011 mode comparison.
# Status: runtime_sanity / exploratory_not_validation.
# Raw VTI/PVTI/PRI stay on HM570; no tar/archive is produced here.

RUN_ROOT="${1:-/mnt/8A0E24070E23EAC1/runs/tclb_flat_wall_cap_stage7b_wall011_modes_20260612}"
LOCAL_CASE_STAGING="${LOCAL_CASE_STAGING:-/tmp/flat_wall_cap_stage7b_wall011_modes_cases}"
BINARY="${BINARY:-/home/yuan/src/TCLB_stage7b_low_angle_signed_wall_stability_diag_20260612/CLB/d3q27_pf_velocity_q27_geometric/main}"
...
CASE_IDS=(
  cap_theta030_wall011_mode0
  cap_theta030_wall011_mode2
  cap_theta030_wall011_mode3
)

FINITE_ARRAYS="PhaseField,U,P,Rho,WallPhasePred,WallPhaseProfilePred,WallPhaseSignedProfilePred,WallPhaseRawPred,WallPhaseSignedPred,WallContactResidual,WallSignedNormalGrad,WallTangentGradMag,WallSignedDeltaQ,WallSignedQClipped,BoundaryMask,WallStage7Mode,WallStage7ActiveWeight,WallStage7DeltaQRaw,WallStage7DeltaQLimited,WallStage7Denom,WallStage7LimiterReason,WallStage7GradMag,WallStage7ActualCos,WallStage7TargetCos,WallStage7WriteCandidate,WallStage7WriteMinusProfile"
...
mkdir -p "$RUN_ROOT"
batch_log="$RUN_ROOT/batch_flat_wall_cap_stage7b_wall011_modes.log"
current_case_dir=""
...

{
  ...
  echo "status=runtime_sanity"
  echo "purpose=flat_wall_spherical_cap_gate_stage7b_wall011_modes"

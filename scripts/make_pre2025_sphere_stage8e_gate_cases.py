#!/usr/bin/env python3
"""Generate Stage8e z48 sphere shadow and initializer-attribution cases."""
...
CASE_DIR = Path("cases") / "diagnostics" / "pre2025_sphere_stage8e_shadow_20260613"
REMOTE_ROOT = "/mnt/8A0E24070E23EAC1/runs/tclb_pre2025_sphere_stage8e_shadow_20260613"
BINARY = (
...
<!--
  Stage8e z48 sphere shadow diagnostic.
...
def main() -> None:
    ...
    manifest = {
        ...
        "purpose": "Stage8e z48 sphere shadow and initializer-attribution gate",
        "binary": args.binary,

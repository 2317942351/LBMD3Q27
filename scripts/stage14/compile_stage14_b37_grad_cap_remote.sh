...
LOG="${LOG:-/home/yuan/lbm2026_stage14_B37_grad_cap_compile_20260628.log}"
...

{
  ...
  grep -q "CudaConstantMemory real_t Stage14B37GradPhiCapMode" "CLB/${TARGET}/cuda.cu"
  grep -q "CudaConstantMemory real_t Stage14B37GradPhiCap" "CLB/${TARGET}/cuda.cu"
  grep -q "#define B37GradPhiPreCapX" "CLB/${TARGET}/cuda.cu"
  grep -q "#define B37GradPhiPostCapX" "CLB/${TARGET}/cuda.cu"
  grep -q "stage14_b37_apply_grad_phi_cap" "CLB/${TARGET}/Dynamics.c"
  grep -q "Stage14B37GradPhiCapMode > 1.5" "CLB/${TARGET}/Dynamics.c"
  grep -q "CudaDeviceFunction vector_t getB37GradPhiPreCap" "CLB/${TARGET}/Dynamics.c"
  grep -q "CudaDeviceFunction vector_t getB37GradPhiPostCap" "CLB/${TARGET}/Dynamics.c"
  grep -q "real_t B37GradPhiPreCapX" "CLB/${TARGET}/Dynamics.h"
  grep -q "real_t B37GradPhiPostCapMag" "CLB/${TARGET}/Dynamics.h"
  grep -q "SETTINGS_Stage14B37GradPhiCapMode" "CLB/${TARGET}/Consts.h"
  grep -q "SETTINGS_Stage14B37GradPhiCap" "CLB/${TARGET}/Consts.h"
  grep -q '"B37GradPhiPreCap"' "CLB/${TARGET}/Lists.cpp"
  grep -q '"B37GradPhiPostCap"' "CLB/${TARGET}/Lists.cpp"
  grep -q "GetB37GradPhiPreCap" "CLB/${TARGET}/Lattice.cu"
  grep -q "GetB37GradPhiPostCap" "CLB/${TARGET}/Solver.cpp"
  grep -q "load_B37GradPhiPreCapX" "CLB/${TARGET}/LatticeAccess.inc.cpp"
  grep -q "load_B37GradPhiPostCapMag" "CLB/${TARGET}/LatticeAccess.inc.cpp"
  echo "CUDA_B37_GRAD_CAP_ACCESSORS_OK=1"

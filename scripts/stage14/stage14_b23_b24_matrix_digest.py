#!/usr/bin/env python3
"""Digest Stage14-B23/B24/B27-B32 probe roots into compact tables.
...
b27-b32 key summaries generated by stage14_b17_onset_mask_argmax.py. This
script only summarizes diagnostic evidence; it does not validate contact angle
or promote a physics mode.
"""
...
def build_rows(root: Path) -> list[dict[str, Any]]:
    ...
    for path in summary_paths(root):
        ...
        row: dict[str, Any] = {
            ...
            "fmu_stress_closure_mode": metadata.get("fmu_stress_closure_mode"),

...
DERIVED_VECTOR_MAG_FIELDS = {
    ...
    "B42FmuLegacyDeviatoricNorm": "B42FmuLegacyDeviatoric",
    "B42FmuRawDeviatoricNorm": "B42FmuRawDeviatoric",
    "B42FmuBGKDeviatoricNorm": "B42FmuBGKDeviatoric",
    "B42ForceOverRhoLegacyDeviatoricNorm": "B42ForceOverRhoLegacyDeviatoric",
    "B42ForceOverRhoRawDeviatoricNorm": "B42ForceOverRhoRawDeviatoric",
    "B42ForceOverRhoBGKDeviatoricNorm": "B42ForceOverRhoBGKDeviatoric",
}
...
THRESHOLDS = {
    ...
    **{
    ...
    "b42_legacy_deviatoric_stress_large": ("B42LegacyDeviatoricNorm", 1.0e3),
    "b42_raw_deviatoric_stress_large": ("B42RawDeviatoricNorm", 1.0e3),
    "b42_bgk_deviatoric_stress_large": ("B42BGKDeviatoricNorm", 1.0e3),
    "b42_post_deviatoric_stress_large": ("B42PostDeviatoricNorm", 1.0e3),
    "b42_fmu_legacy_deviatoric_large": ("B42FmuLegacyDeviatoricNorm", 1.0e3),
    "b42_fmu_raw_deviatoric_large": ("B42FmuRawDeviatoricNorm", 1.0e3),
    "b42_fmu_bgk_deviatoric_large": ("B42FmuBGKDeviatoricNorm", 1.0e3),
    "b42_force_legacy_deviatoric_large": ("B42ForceOverRhoLegacyDeviatoricNorm", 1.0e3),
    "b42_force_raw_deviatoric_large": ("B42ForceOverRhoRawDeviatoricNorm", 1.0e3),
    "b42_force_bgk_deviatoric_large": ("B42ForceOverRhoBGKDeviatoricNorm", 1.0e3),

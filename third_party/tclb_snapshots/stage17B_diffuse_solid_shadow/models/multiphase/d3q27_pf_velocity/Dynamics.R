...
# Stage17B diffuse-solid curved-wetting shadow diagnostics. These fields are
# output-only in B2. They must not feed back into PhaseF or WallGhost until a
# later controlled-write gate explicitly enables that behavior.
AddField("PsiSolid", stencil3d=1, group="solid_boundary")
AddField("PsiGradMag", stencil3d=1, group="solid_boundary")
...
AddField("ReplayHPreSum", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayHPostSum", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayHeqSum", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayHPreMaxAbs", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayHPostMaxAbs", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayHeqMaxAbs", stencil3d=1, group="runtime_diagnostics")
...
AddField("ReplayTmp1BoundedShadow", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayPhaseOutOfBoundsFlag", stencil3d=1, group="runtime_diagnostics")
...
AddField("ReplayStressPreForceShadowXX", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayStressPreForceShadowXY", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayStressPreForceShadowXZ", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayStressPreForceShadowYY", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayStressPreForceShadowYZ", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayStressPreForceShadowZZ", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayStressPostForceShadowXX", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayStressPostForceShadowXY", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayStressPostForceShadowXZ", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayStressPostForceShadowYY", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayStressPostForceShadowYZ", stencil3d=1, group="runtime_diagnostics")
AddField("ReplayStressPostForceShadowZZ", stencil3d=1, group="runtime_diagnostics")
...
#######################
	...
	AddQuantity(name="ReplayHPreSum", unit=1)
	AddQuantity(name="ReplayHPostSum", unit=1)
	AddQuantity(name="ReplayHeqSum", unit=1)
	AddQuantity(name="ReplayHPreMaxAbs", unit=1)
	AddQuantity(name="ReplayHPostMaxAbs", unit=1)
	AddQuantity(name="ReplayHeqMaxAbs", unit=1)
	AddQuantity(name="ReplayFphiSum", unit=1)
	AddQuantity(name="ReplayFphiMaxAbs", unit=1)
	AddQuantity(name="ReplayTmp1", unit=1)
	AddQuantity(name="ReplayTmp1BoundedShadow", unit=1)
	AddQuantity(name="ReplayPhaseOutOfBoundsFlag", unit=1)
	...
	AddQuantity(name="ReplayStressPreForceShadowXX", unit=1)
	AddQuantity(name="ReplayStressPreForceShadowXY", unit=1)
	AddQuantity(name="ReplayStressPreForceShadowXZ", unit=1)
	AddQuantity(name="ReplayStressPreForceShadowYY", unit=1)
	AddQuantity(name="ReplayStressPreForceShadowYZ", unit=1)
	AddQuantity(name="ReplayStressPreForceShadowZZ", unit=1)
	AddQuantity(name="ReplayStressPostForceShadowXX", unit=1)
	AddQuantity(name="ReplayStressPostForceShadowXY", unit=1)
	AddQuantity(name="ReplayStressPostForceShadowXZ", unit=1)
	AddQuantity(name="ReplayStressPostForceShadowYY", unit=1)
	AddQuantity(name="ReplayStressPostForceShadowYZ", unit=1)
	AddQuantity(name="ReplayStressPostForceShadowZZ", unit=1)
...
###################################
	...
	AddSetting(name="Stage17BShadowThetaDeg", default=-1.0, comment='Stage17B shadow-only theta override in degrees; <0 uses local radAngle and never changes legacy WallGhost')
